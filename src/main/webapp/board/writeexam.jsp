...
<main class="main">
	...
	<c:set var="writeTitle" value="title"/>
    <div class="page-title light-background">
      <div class="container">
        <h1 id="write_title">${empty writeTitle ? "제목 없음" : writeTitle}</h1> 
          ...
          <div class="project-meta-grid" style="padding-top:0">
			...
			<div class="meta-column position-relative">
				...
				<input type="text" id="write_title_input" 
			           ...
			           value='${empty writeTitle ? "제목 없음" : writeTitle}'
    ...
    <div id="spot-pane-<%= ii %>-<%= i %>" class="tab-pane fade <%= i==0 ? "show active" : "" %>" style="margin-bottom: 50px;">
      ...
      <div class="visual-showcase">
        <div class="main-visual">
          ...
          <button type="button" class="btn btn-primary float-end" data-mdb-ripple-init style="background-color:#5c99ee">저장</button>
        </div>
